...
def test_calculation_str_representation_addition(mock_addition):
    ...
    is formatted correctly, displaying the class name, Operations, operands, and result.
    """
    # Arrange
    a = 10.0
    b = 5.0
    ...
    # Assert
    # Expected string should reflect the Operations name derived from the class name ('Add')
...
def test_calculation_str_representation_subtraction(mock_subtraction):
    ...
    # Assert
    # Expected string should reflect the Operations name derived from the class name ('Subtract')
...
def test_calculation_str_representation_multiplication(mock_multiplication):
    ...
    # Assert
    # Expected string should reflect the Operations name derived from the class name ('Multiply')
...
def test_calculation_str_representation_division(mock_division):
    ...
    # Assert
    # Expected string should reflect the Operations name derived from the class name ('Divide')
...
def test_calculation_execute_parameterized(
    ...
    # Assert: Verify the correct Operations was called and result matches
    if calc_type == 'add':
